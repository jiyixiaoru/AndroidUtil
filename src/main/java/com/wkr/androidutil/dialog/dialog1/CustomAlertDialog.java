...
public class CustomAlertDialog extends Dialog implements TickTimer.TickTimerListener, android.view.View.OnClickListener {
    ...
    public static final int IMAGE_PROMPT_TYPE = 7;
    ...
    public void onFinish() {
        ...
        if (mAlertType == ERROR_TYPE || mAlertType == SUCCESS_TYPE || mAlertType == IMAGE_PROMPT_TYPE) {
            if (getContext() != null && !isActivityFinish(getContext())) {
